  ...
  return (
    <div className="lg:flex lg:gap-x-12">
      <div className="lg:w-[35%]">
        <SetupSidebar active={active} setActive={setActive} />
      </div>
      <div className="lg:w-[65%]">
        {active === 1 && <ProfileSetup next={() => setActive(2)} />}
        {active === 2 && (
          <SetupPhotos prev={() => setActive(1)} next={() => setActive(3)} />
        )}
        {active === 3 && (
          <SetupBio prev={() => setActive(2)} next={() => setActive(4)} />
        )}
        {active === 4 && (
          <SetupSocials prev={() => setActive(3)} next={() => setActive(5)} />
        )}
