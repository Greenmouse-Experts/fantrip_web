  ...
  return (
    <div>
        ...
        <div className="mt-6 flex gap-x-1">
            ...
            <p className="fs-400">Please note, for safety and verification purposes, your real name is required to list your accommodation. This information will be used solely for booking transactions and will not be visible in other parts of the app.</p>
        </div>
        <div className="lg:w-7/12 mt-8">
            <TextInput type={InputType.text} label="Enter Full Legal Names" labelClassName="text-[#9F9F9F]"/>
        </div>
