  ...
  return (
    <div className="text-center">
      ...
      <p className="lg:w-7/12 mt-4 mx-auto">
        Your host profile has been set up, and you can now create your listings.
        Also, note that your account can only be verified if the information
        submitted during your setup meets fantrip guidelines.
      </p>
