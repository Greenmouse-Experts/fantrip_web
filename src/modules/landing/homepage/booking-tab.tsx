...
const BookingTab = () => {
  return (
    <div className="box">
      <div className="w-full bg-white book-tab-border px-6 py-3 lg:pl-12">
        <div className="flex w-full ">
          <div className="grid grid-cols-4 divide-x divide-gray-400 w-full">
          ...
          <div className="">
            <Button title={"Search"} altClassName="btn-primary shrink-0 py-4 lg:py-5 lg:px-16 fw-600 px-12" />
          </div>
        </div>
      </div>
    </div>
