...
const SelectNaming: FC<Props> = ({
  ...
  return (
    <div className="text-center">
      <p className="syne fw-600 text-2xl">Choose how to display your name</p>
      <p className="fw-500 my-5 text-[#505050] w-10/12 mx-auto">
      ...
      <div className=" my-5 lg:my-12 grid grid-cols-2 gap-4 lg:w-10/12 mx-auto">
