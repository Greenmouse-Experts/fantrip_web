      ...
      <div className="mt-12">
        <ul className="grid gap-5">
          <li className="border-b">
            ...
            <span><img src={icon_4} alt="" /></span>
            <span></span>
              Home
            </Link>
          </li>
          <li className="border-b">
            <Link to={"/find-stay"} className="px-3 flex items-center gap-2 pb-1">
            <span><img src={icon_5} alt="" /></span>
              Find a fan stay
            </Link>
          </li>
          <li className="border-b">
            <Link to={"/user/host-setup"} className="px-3 flex items-center gap-2 pb-1">
            <span><img src={icon_8} alt="" /></span>
              Host a fan
            </Link>
          </li>
          <li className="border-b">
            <Link to={"/area-guide"} className="px-3 flex items-center gap-2 pb-1">
            <span><img src={icon_1} alt="" /></span>
              Area Guide
            </Link>
          </li>
          <li className="border-b">
            <Link to={"/chat-room"} className="px-3 flex items-center gap-2 pb-1" >
            <span><img src={icon_2} alt="" /></span>
              Chat Room
            </Link>
          </li>
          <li className="border-b">
            <Link to={"/auth/login"} className="px-3 flex items-center gap-2 pb-1">
